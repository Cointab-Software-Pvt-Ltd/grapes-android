...
class SummaryBlockContentAdapter : RecyclerView.Adapter<SummaryBlockContentAdapter.SummaryBlockContentViewHolder>() {
    ...
    sealed class SummaryBlockContentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        class IconDescription(val view: IconDescriptionItemView) : SummaryBlockContentViewHolder(view)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SummaryBlockContentViewHolder =
        when (SummaryBlockContentViewType.entries[viewType]) {
            ...
            SummaryBlockContentViewType.ICON_DESCRIPTION -> SummaryBlockContentViewHolder.IconDescription(IconDescriptionItemView(parent.context))
        }.apply {
    ...
    override fun onBindViewHolder(holder: SummaryBlockContentViewHolder, position: Int) =
        when (holder) {
            ...
            is SummaryBlockContentViewHolder.IconDescription -> {
                val data = (listItems[position] as SummaryBlockContentModel.IconDescription)
