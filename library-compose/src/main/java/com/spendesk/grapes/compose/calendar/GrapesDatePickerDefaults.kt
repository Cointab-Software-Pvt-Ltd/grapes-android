...
object GrapesDatePickerDefaults {
    ...
    @Composable
    fun colors(
        containerColor: Color = GrapesTheme.colors.backgroundSecondaryDefault,
        titleContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        headlineContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        weekdayContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        subheadContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        yearContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        currentYearContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        selectedYearContentColor: Color = GrapesTheme.colors.contentComplementary,
        selectedYearContainerColor: Color = GrapesTheme.colors.backgroundPrimaryBrandDefault,
        dayContentColor: Color = GrapesTheme.colors.contentSecondaryBGSecondary,
        selectedDayContentColor: Color = GrapesTheme.colors.contentComplementary,
        selectedDayContainerColor: Color = GrapesTheme.colors.backgroundPrimaryBrandDefault,
        todayContentColor: Color = GrapesTheme.colors.contentSelected,
        todayDateBorderColor: Color = GrapesTheme.colors.contentSelected,
